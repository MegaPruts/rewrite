...
import static org.openrewrite.Validated.*;
...
public class ChangeDependencyGroupIdAndArtifactId extends Recipe {
    ...
    @Option(displayName = "Old groupId",
            description = "The old groupId to replace. The groupId is the first part of a dependency coordinate `com.google"
                    + ".guava:guava:VERSION`. Supports glob expressions.",
            example = "org.openrewrite.recipe")
    String oldGroupId;

    @Option(displayName = "Old artifactId",
            description = "The old artifactId to replace. The artifactId is the second part of a dependency coordinate `com.google"
                    + ".guava:guava:VERSION`. Supports glob expressions.",
    ...
    @Option(displayName = "Override managed version",
            description = "If the new dependency has a managed version, this flag can be used to explicitly set the version on the "
                    + "dependency. The default for this flag is `false`.",
            required = false)
    @Nullable
    ...
    public ChangeDependencyGroupIdAndArtifactId(String oldGroupId, String oldArtifactId, @Nullable String newGroupId,
    ...
    public TreeVisitor<?, ExecutionContext> getVisitor() {
        return new MavenVisitor<ExecutionContext>() {
            ...
            final VersionComparator versionComparator =
                    newVersion() != null ? Semver.validate(newVersion(), versionPattern).getValue() : null;
            @Nullable
            ...
            public Xml visitTag(Xml.Tag tag, ExecutionContext ctx) {
                ...
                if (isOldDependencyTag || isPluginDependencyTag(oldGroupId, oldArtifactId)) {
                    ...
                    boolean configuredToOverrideManageVersion =
                            overrideManagedVersion != null && overrideManagedVersion; // False by default
                    boolean configuredToChangeManagedDependency =
                            changeManagedDependency == null || changeManagedDependency; // True by default
                    try {
                        ...
                        if (newVersion == null) {
                            ...
                            if (versionTagPresent) {
                                ...
                                if (!configuredToOverrideManageVersion && newDependencyManaged || (oldDependencyManaged
                                ...
                                //If the version is not present, add the version if we are explicitly overriding a managed version or if
                                // no managed version exists.
                                Xml.Tag newVersionTag = Xml.Tag.build("<version>" + resolvedNewVersion + "</version>");
                                //noinspection ConstantConditions
                                t = (Xml.Tag) new AddToTagVisitor<ExecutionContext>(t, newVersionTag,
                                        new MavenTagInsertionComparator(t.getChildren())).visitNonNull(t, ctx, getCursor().getParent());
                            }
                        }
            ...
            private boolean checkIfNewDependencyPresents(@Nullable String groupId, @Nullable String artifactId, @Nullable String
                    version) {
            ...
            private String resolveSemverVersion(ExecutionContext ctx, String groupId, String artifactId, @Nullable String
                    currentVersion) throws MavenDownloadingException {
    ...
    private String newVersion() {
        return "*none".equals(newVersion) ? null : newVersion;
    }
}
